...
public class AddressController {
	...
	public String newAddress(Model model) {
		...
		model.addAttribute("pageTitle", "Añadir direccion");
	...
	public String editAddress(@PathVariable("id") Integer addressId, Model model,
		...
		model.addAttribute("listCountries", listCountries);
		model.addAttribute("pageTitle", "Editar direccion (ID: " + addressId + ")");
	...
	public String deleteAddress(@PathVariable("id") Integer addressId, RedirectAttributes ra,
		...
		ra.addFlashAttribute("message", "La direccion ID " + addressId + " ha sido borrada.");
