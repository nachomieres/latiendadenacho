package com.tiendadenacho.checkout.paypal;
...
private static final String GET_ORDER_API = "/v2/checkout/orders/";
	...
	private void throwExceptionForNonOKResponse(HttpStatus statusCode) throws PayPalApiException {
		...
		switch (statusCode) {
		case NOT_FOUND: 
			message = "Order ID no encotrada";
			
		case BAD_REQUEST:
			message = "Llamada incorrecta a la API checkout de PayPal";
			
		case INTERNAL_SERVER_ERROR:
			message = "Error del servidod PayPal";
			
		default:
			message = "PayPal retorna codigo de error no-OK";
		}
