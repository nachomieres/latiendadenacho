package com.tiendadenacho.admin.order;
...
import com.tiendadenacho.entidades.OrderDetail;
import com.tiendadenacho.entidades.OrderStatus;
import com.tiendadenacho.entidades.PaymentMethod;
...
public class OrderRepositoryTests {
	...
	public void testCreateNewOrderWithSingleProduct() {
		...
		mainOrder.setPaymentMethod(PaymentMethod.TARJETA_CREDITO);
		mainOrder.setStatus(OrderStatus.NUEVO);
	...
	public void testUpdateOrder() {
		...
		assertThat(updatedOrder.getStatus()).isEqualTo(OrderStatus.ENVIADO);
	}
