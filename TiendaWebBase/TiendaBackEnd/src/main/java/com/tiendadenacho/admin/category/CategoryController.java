...
public class CategoryController {
	...
	public String listByPage (@PathVariable (name="pageNum") int pageNum,
		...
		List<Category> listCategories = service.listByPagge(pageInfo, pageNum, sortDir, keyword);
		
		long startCount = (pageNum - 1) * CategoryService.ROOT_CATEGORIES_PER_PAGE + 1;
		long endConut = startCount + CategoryService.ROOT_CATEGORIES_PER_PAGE - 1;
		if (endConut > pageInfo.getTotalElements()) {
			endConut = pageInfo.getTotalElements();
		}
		...
		model.addAttribute("endCount", endConut);
...
//			FileUploadUtil.saveFile(uploadDir, fileName, multipartFile);			
		...
		redirectAttributes.addFlashAttribute("message", "La categoria se ha guardado correctamente.");
	...
	public String updateCategoryEnabledStatus(@PathVariable("id") Integer id,
		...
		String status = enabled ? "activada" : "desactivada";
		String message = "La categoria con ID " + id + " ha sido " + status;
