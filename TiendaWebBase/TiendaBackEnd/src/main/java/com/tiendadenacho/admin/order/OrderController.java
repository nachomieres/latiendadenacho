...
public class OrderController {
	...
	public String viewOrderDetails(@PathVariable("id") Integer id, Model model, 
		...
		try {
			...
			if (loggedUser.hasRole("Admin") || loggedUser.hasRole("Gestor")) {
	...
	public String deleteOrder(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) {
		try {
			...
			ra.addFlashAttribute("message", "El pedido con ID " + id + " ha sido borrado.");
		} catch (OrderNotFoundException ex) {
			ra.addFlashAttribute("message", ex.getMessage());
		}
	...
	public String editOrder(@PathVariable("id") Integer id, Model model, RedirectAttributes ra,
		...
		try {
			...
			model.addAttribute("pageTitle", "Editar pedido (ID: " + id + ")");
			model.addAttribute("order", order);
	...
	public String saveOrder(Order order, HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "El pedido con ID " + order.getId() + " ha siudo actualizado correctamente.");
