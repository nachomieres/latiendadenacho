...
public class UserService {
	...
	public List<User> listAll() {
		return (List<User>) userRepo.findAll(Sort.by("nombre").ascending());
	}
	...
	public User updateAccount (User userInForm) {
		...
		if (userInForm.getFoto() != null) {
			userInDB.setFoto(userInForm.getFoto());
		}
		
		userInDB.setNombre(userInForm.getNombre());
		userInDB.setApellidos(userInForm.getApellidos());
